...
/**
 * Provides a Dermau Stats Highlight Block.
 *
 * @Block(
 *   id = "dermau_stats_highlight_block",
 *   admin_label = @Translation("Dermau Stats Highlight Block"),
 * )
 */
class StatsHighlightBlock extends BlockBase
{
